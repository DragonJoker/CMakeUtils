...
find_path(JASPER_INCLUDE_DIR jasper/jasper.h HINTS ${VCPKG_TRIPLET_DIR}/include)
mark_as_advanced(JASPER_INCLUDE_DIR)

if(NOT JASPER_LIBRARIES)
  find_package(JPEG)
  find_library(JASPER_LIBRARY_RELEASE NAMES jasper libjasper HINTS ${VCPKG_TRIPLET_DIR}/lib)
  find_library(JASPER_LIBRARY_DEBUG NAMES jasperd HINTS ${VCPKG_TRIPLET_DIR}/debug/lib)
