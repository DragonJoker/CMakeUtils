...
if ( NOT Castor3D_FIND_COMPONENTS )
	set( Castor3D_FIND_COMPONENTS CastorUtils GlslWriter Castor3D GuiCommon )
endif ()
...
foreach( COMPONENT ${Castor3D_FIND_COMPONENTS} )
	set( ABI_Name )
	set( ABI_Name_Debug )
	if ( ${COMPONENT} STREQUAL GuiCommon )
		compute_abi_name( ABI_Name ABI_Name_Debug )
	else ()
		set( ABI_Name )
		set( ABI_Name_Debug "d" )
	endif ()
	find_path( Castor3D_${COMPONENT}_ROOT_DIR include/${COMPONENT}/${COMPONENT}Prerequisites.hpp
		HINTS
		PATH_SUFFIXES
			Castor3D
		PATHS
	...
	mark_as_advanced( Castor3D_${COMPONENT}_LIBRARY_RELEASE_DIR )
	mark_as_advanced( Castor3D_${COMPONENT}_LIBRARY_DEBUG_DIR )
