...
#    GTK3_TARGETS - All imported targets
...
# ::
#
#    Require GTK 3.0 or later and Glade
#        find_package(GTK3 3.0 REQUIRED gtk glade)
#
#
#
# ::
#
#    Search for GTK/GTKMM 3.0 or later
...
function(_GTK3_FIND_LIBRARY _var _lib _expand_vc _append_version)
    ...
    set(_versions 3.0 2.20 2.18 2.16 2.14 2.12
...
foreach(_GTK3_component ${GTK3_FIND_COMPONENTS})
    if(_GTK3_component STREQUAL "gtk")
        ...
        _GTK3_FIND_INCLUDE_DIR(GDKCONFIG gdkconfig.h)
        if(UNIX)
            if(APPLE)
    ...
    elseif(_GTK3_component STREQUAL "glade")
        ...
        _GTK3_ADD_TARGET      (GLADE GTK3_DEPENDS gtk gdk atk gio pangoft2 gdk_pixbuf pango gobject glib
                                     GTK3_OPTIONAL_DEPENDS pangocairo cairo
                                     OPTIONAL_INCLUDES ${FREETYPE_INCLUDE_DIR_ft2build} ${FREETYPE_INCLUDE_DIR_freetype2}
                                                       ${GTK3_FONTCONFIG_INCLUDE_DIR}
                                                       ${GTK3_X11_INCLUDE_DIR})
    ...
    elseif(_GTK3_component STREQUAL "glademm")
        ...
        _GTK3_ADD_TARGET      (GLADEMM GTK3_DEPENDS gtkmm glade atkmm gdkmm giomm pangomm glibmm sigc++ gtk gdk atk pangoft2 gdk_pixbuf pango gthread gobject glib
                                       GTK3_OPTIONAL_DEPENDS giomm cairomm gio pangocairo cairo
                                       OPTIONAL_INCLUDES ${FREETYPE_INCLUDE_DIR_ft2build} ${FREETYPE_INCLUDE_DIR_freetype2}
                                                         ${GTK3_FONTCONFIG_INCLUDE_DIR}
                                                         ${GTK3_X11_INCLUDE_DIR})
