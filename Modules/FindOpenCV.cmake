...
if(EXISTS "${OpenCV_DIR}")
	...
	#Otherwise it try to guess it.
		...
		if( EXISTS  ${OpenCV_INCLUDE_DIR}/opencv/cvver.h )
			...
			file(STRINGS ${OpenCV_INCLUDE_DIR}/opencv/cvver.h OpenCV_VERSIONS_TMP REGEX "^#define CV_[A-Z]+_VERSION[ \t]+[0-9]+$")
		...
		elseif( EXISTS  ${OpenCV_INCLUDE_DIR}/opencv2/core/version.hpp )
			...
			if (${CVLIB_SUFFIX} LESS "230")
				...
				set(OPENCV_LIB_COMPONENTS calib3d contrib core features2d flann highgui imgproc legacy ml objdetect video)
			endif()
		endif()
	...
	foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
		find_library(
			...
			NAMES
				...
				"lib${__CVLIB}d"
				"opencv_${__CVLIB}${CVLIB_SUFFIX}d.lib"
				"opencv_${__CVLIB}d.lib"
				"libopencv_${__CVLIB}${CVLIB_SUFFIX}d.a"
		...
		find_library(
			...
			NAMES
				"${__CVLIB}${CVLIB_SUFFIX}"
				"${__CVLIB}"
				"lib${__CVLIB}${CVLIB_SUFFIX}"
				"lib${__CVLIB}"
				"opencv_${__CVLIB}${CVLIB_SUFFIX}.lib"
				"opencv_${__CVLIB}.lib"
				"libopencv_${__CVLIB}${CVLIB_SUFFIX}.a"
