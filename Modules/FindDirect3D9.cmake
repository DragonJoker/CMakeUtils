...
if( WIN32 )
	...
	FIND_LIBRARY(D3D9_DXERR_LIBRARY_DEBUG
	  NAMES dxerr.lib
	  HINTS
	  PATH_SUFFIXES Lib/x64
	  PATHS
	...
	if ( DIRECT3D9_FOUND )
		set( D3D9_LIBRARIES optimized ${D3D9_LIBRARY} ${D3D9_X_LIBRARY_RELEASE} debug ${D3D9_LIBRARY} ${D3D9_X_LIBRARY_DEBUG} ${D3D9_DXERR_LIBRARY_DEBUG} CACHE STRING "Direct3D9 libraries" )
	endif()
endif()