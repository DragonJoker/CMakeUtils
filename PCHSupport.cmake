...
MACRO( add_target_precompiled_header_legacy TARGET_NAME PROJ_GROUP PCH_HEADER PCH_SOURCE TARGET_CXX_FLAGS )
	if ( PROJECTS_USE_PRECOMPILED_HEADERS )
		...
		msg_debug( "PCH:     PCH_HEADER ${PCH_HEADER}" )
		msg_debug( "PCH:     PCH_SOURCE ${PCH_SOURCE}" )
		msg_debug( "PCH:     TARGET_CXX_FLAGS ${TARGET_CXX_FLAGS}" )
		...
		msg_debug( "PCH:     ARGN             ${ARGN}" )
		msg_debug( "PCH:     PCH_INCLUDE_NAME ${PCH_INCLUDE_NAME}" )
		msg_debug( "PCH:     PCH_SOURCE_PATH  ${PCH_SOURCE_PATH}" )
		msg_debug( "PCH:     PCH_SOURCE       ${PCH_SOURCE}" )
		if ( MSVC )
			foreach ( SRC ${ARGN} )
